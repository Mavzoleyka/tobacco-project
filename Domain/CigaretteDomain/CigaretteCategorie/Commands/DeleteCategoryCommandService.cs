...
{
    public class DeleteCategoryCommandService : ICommandService<DeleteCategoryDTO>
    {
        private readonly ICigaretteCategoryRepository _repository;
        public DeleteCategoryCommandService(ICigaretteCategoryRepository repository)
        {
            ArgumentNullException.ThrowIfNull(repository, nameof(repository));
            _repository = repository;
        }

        public async Task Execute(DeleteCategoryDTO obj)
        {
            if(obj == null)
            {
